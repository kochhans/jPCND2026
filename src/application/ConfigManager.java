...
public class ConfigManager {
    ...
    public static synchronized void reload() {
        try (InputStream in = Files.newInputStream(CONFIG_FILE)) {
            props.clear(); // 🔥 wichtig!
            props.load(in);
            System.out.println("♻️ Config neu geladen");
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static synchronized void save() {
        ...
        // 🔥 sofort neu laden → kein Cache-Problem
        reload();
    }
    ...
    // 🔥 NEU: Validierung
    // ----------------------------------------
    public static boolean hasValidDBPath() {
    ...
    public static String getLicenseCreateUrl() {
        return "https://www.pcnd.eu/jpcnd/license-api/create_license.php";
    }
